...
- Resource-flow tracing for tax base, command remittance, local retention, formal resource allocation, war supply draws, muster costs, and war-loot remittance
